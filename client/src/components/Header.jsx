...
const Header = () => {
   return (
      <div className="flex items-center justify-between max-sm:flex-colreverse gap-y-10 px-4 mt-10 lg:px-44 sm:mt-20 ">
         {/* Left Side */}
         <div className="">
            ...
            <p className="my-6 text-gray-500 text-[15px]">
               Easily remove backgrounds from photos — upload an image to get
               started.
            </p>
            <div>
